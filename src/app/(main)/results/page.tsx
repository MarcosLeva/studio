      ...
      {isMobile ? (
        <div className="space-y-4">
          ...
          {table.getFilteredRowModel().rows?.length ? (
            ...
            <div className="text-center py-10 text-muted-foreground">Aún no hay resultados</div>
          )}
        </div>
      ) : (
        <div>
      ...
      >
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Esta acción no se puede deshacer. Esto eliminará permanentemente el resultado del análisis para{' '}
      ...
      <AlertDialog open={isBulkDeleteOpen} onOpenChange={setIsBulkDeleteOpen}>
        <AlertDialogContent>
            <AlertDialogHeader>
                <AlertDialogTitle>¿Estás realmente seguro?</AlertDialogTitle>
                <AlertDialogDescription>
                  Esta acción no se puede deshacer. Esto eliminará permanentemente los {table.getFilteredSelectedRowModel().rows.length} resultados seleccionados.
                </AlertDialogDescription>
            </AlertDialogHeader>
            <AlertDialogFooter>
